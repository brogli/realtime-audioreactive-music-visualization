...
{
    // This class is almost entirely copied from https://github.com/keijiro/jp.keijiro.rtmidi/tree/master/Assets
    ...
    unsafe public sealed class MidiInPort : System.IDisposable
    {
        ...
        public System.Action<byte> OnClockMessgeReceived;
        ...
        public void ProcessMessages()
        {
            ...
            while (true)
            {
                ...
                {
                    OnClockMessgeReceived?.Invoke(channel);
                }
            }
        }
    }
